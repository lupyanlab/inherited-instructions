...
(ref:gabors) Gabors sampled from the solution landscape. Gabors are sinusoidal stimuli

```{r gabors, fig.cap="(ref:gabors)"}
draw_image("SimpleHillGems", package = "gems")
```

```{r training, fig.width=10, fig.height=8}
gridExtra::grid.arrange(
  read_image("welcome_orientation", package = "gems"),
  read_image("training_orientation", package = "gems"),
  read_image("welcome_spatial_frequency", package = "gems"),
