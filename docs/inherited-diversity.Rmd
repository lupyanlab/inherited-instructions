...
future generations are able to benefit from the solutions achieved by previous
generations. The purpose of this research was to understand the conditions
under which inheriting from a previous generation may future problem
...
In confidence matching tasks, teamwork improves team performance over what
could be achieved by each individual specifically when the members of the team
have the similar perceptual abilities. This finding contrasts with other
research on teamwork that has found a benefit to diversity among team members.
In tasks requiring problem solvers to search a space of possible solutions,
homogeneous teams of problem solvers, where all team members have equal skill,
may prematurely convergence on suboptimal solutions, whereas heterogeneous
teams are able to avoid these pitfalls, and maintain a wider search for
globally optimal solutions. These results have been used to argue that
diversity among team members is an effective means of improving team
performance.
