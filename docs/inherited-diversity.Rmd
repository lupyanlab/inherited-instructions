...
data_frame(question_text = colnames(Survey)) %>%
  ...
  kable(questions, caption="(ref:survey-questions)")
```
...
(ref:gems-training) Training procedure. Participants were randomly assigned to either
the orientation or the spatial frequency condition.

```{r gems-training, fig.width=8, fig.height=8, fig.cap="(ref:gems-training)"}
gridExtra::grid.arrange(
  orientation_bias,
  orientation_training_plot,
  spatial_frequency_bias,
  spatial_frequency_training_plot,
  nrow = 2
)
```
