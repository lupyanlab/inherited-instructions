...
problems. Instead, they start off with the solutions that were inherited from a
previous generation. Does the accumulation of problem solving knowledge
impact future generations of problem solvers beyond simply giving a head start
on future labor? The purpose of this research was to understand the conditions
...
could have been accomplished individually. Larger teams are subject to effects
such as social loafing that decrease motivation and performance. Larger teams
...
which new changes can be implemented.

A notable exception is a study by @Bahrami:2010jl who found that
