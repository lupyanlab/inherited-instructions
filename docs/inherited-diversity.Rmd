...
better our understanding of how inheritance from a previous generation can
influence future problem solving behavior.
...
presented displays of sinusoidal gabor patches that varied in orientation and
spatial frequency. We asked them to think of the gabor patches as "gems"
existing on a foreign planet. Their job was to figure out which gems were
...
of this landscape, looking for the highest peaks, corresponding
...
within a radial distance in stimulus space of the gabor selected on the previous
trial. As a result, in order to find the most valuable gems, participants had to
move through the stimulus space in a series of incremental steps.
...
and 30 training trials. The instructions told participants that the value of
the gems was determined by either the orientation or the bar width. The training
trials were completed on a landscape that was designed to value the trained
stimulus dimension but not the untrained dimension. The training procedure
is described in more detail below.

Participants were also assigned to the first or second generation.
First generation participants started at the origin `(0,0)` on each landscape.
Second generation participants started at the location on the landscape of the
gem selected by a first generation participant. There was no
...
In our analyses, we were interested in the comparison of three problem solving
strategies (Fig. \@ref(fig:gems-team-strategies)). Congruent
