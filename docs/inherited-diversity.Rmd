...
language, and other social learning abilities. A consequence of our system of
cultural inheritance is that problem solvers rarely have to start from scratch
when solving new problems. Instead, they start off with the solutions that were
inherited from a previous generation. The goal of this research was to
understand how inheriting from a previous generation influences future problem
solving behavior.
