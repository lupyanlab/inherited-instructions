...
abstract: |
  ...
  a problem solving task with a solution discovered by someone else---on
  future problem solving performance. We found that teams of complementary problem
  solvers, who learned different but complementary skills, outperformed equally
  skilled individuals given the same total number of trials. These results
  illustrate how our system of cultural inheritance can cumulatively improve
  problem solving performance over generations beyond what would be achieved by
...
and language that improve the success of cultural inheritance, or what
is known as high fidelity cultural transmission [@Lewis:2012jg; @Dean:2012gv].
The idea that some problem solving behaviors can be accurately copied
by others via social learning is uncontroversial, but what is not fully
agreed upon is the importance of accurate transmission in explaining
the nature of human cultural evolution. Sperber and others [-@Sperber:1996exc;
@Claidiere:2010kd] have argued that accurate copying is rare, and
that cultural transmission is better understood as a
...
Accurate transmission of problem solving knowledge is important both because it
enables others to benefit from complex solutions they themselves could not have
created, but also because accurate transmission increases the likelihood that
future generations could cumulatively improve upon the solutions discovered by
their ancestors. On this view, the human propensity to incrementally improve
solutions to problems over generations is a driving force in human cultural
evolution.
