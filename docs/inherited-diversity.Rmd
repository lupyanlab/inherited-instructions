...
Although participants in both training conditions proceeded in orthogonal directions,
they did not do so equally. Participants trained on bar width were able
to move further toward their peak gem in fewer trials than participants trained on orientation,
`r r_$training_distance_linear_trial_v_instructions`.
