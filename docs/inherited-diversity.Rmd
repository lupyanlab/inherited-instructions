...
abstract: |
  ...
  partial solution discovered by someone else on future problem solving
  performance. We found that teams of complementary problem solvers, who learned
  different but complementary skills, outperformed equally skilled individuals
  given the same total number of trials. The results illustrate how our system
  of cultural inheritance can cumulatively improve problem solving performance
  over generations beyond what would be achieved by individuals working alone.
