...
[@Tennie:2009gaa]. Humans have evolved a number of abilities that improve the
success of cultural transmission, including imitation, teaching, and language
[@Lewis:2012jg; @Dean:2012gv]. As a result, problem solvers rarely have to
start from scratch when solving new problems. Instead, they start off with the
solutions that were inherited from a previous generation. What are the
consequences of inheriting from a previous generation on future problem
solving performance?
...
would have taken to solve some problem on their own, and instead can spend
...
than any individual lifetime. Over time, we have come to depend on this system
...
right panels illustrate counterbalancing conditions.
