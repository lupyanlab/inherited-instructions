...
a more perceptual constant dimension, we expanded the distance between adjacent,
...
frequency. The dimensions of orientation and spatial frequency
correspond to a position on a landscape, where the height of the landscape
is the value of the gem. There were two different training
...
Participants were instructed they would play a computer game where they 
pretend to be a space explorer who travels to another planet to collect
precious gems. Their goal was to learn which gems are worth more than others so
that they could get the highest score in the game.

Participants completed a training block of 30 trials, followed by four
test blocks of 40 trials each. In the training block, participants traversed
