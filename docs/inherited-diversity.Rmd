...
abstract: |
  One of the consequences of our system of cultural inheritance is that problem
  solvers rarely have to start from scratch when solving new problems. Instead,
  they start off with solutions that were discovered by a previous generation.
  Here we investigated the impact of starting off a problem solving task with a
  solution discovered by someone else on future problem solving performance. We
  found that teams of complementary problem solvers, who learned different but
  complementary skills, outperformed equally skilled individuals given the same
  total number of trials. The results illustrate how our system of cultural
  inheritance can cumulatively improve problem solving performance over
  generations beyond what would be achieved by individuals working alone.
keywords: cultural evolution, problem solving, diachronic collaboration
---
...
[@Dean:2012gv]. A consequence of our system of cultural inheritance is that
problem solvers rarely have to start from scratch when solving new problems.
Instead, they start off with the solutions that were inherited from a previous
generation. A question that arises when considering the consequences of
cultural inheritance on human problem solving is the extent to which future
generations are able to benefit from the solutions discovered by previous
generations.
